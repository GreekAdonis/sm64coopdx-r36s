...
override_disallowed_functions = {
    ...
    "src/engine/lighting_engine.h":             [ "le_calculate_vertex_lighting", "le_clear", "le_shutdown", "le_has_active_lights", "le_calculate_ambient_color", "le_calculate_vertex_ambient_color" ],
}
